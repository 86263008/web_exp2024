...
public interface CourseDao {
   ...
   */
  public int create(Course newValue);
   ...
   * @return 非空对象列表
   */
  public List<Course> getPage(@Param("params")Map<String, Object> params, @Param("pageNum") int pageNum, @Param("pageSize") int pageSize);
   ...
   * @return 非空对象列表
   */
  public List<Course> getItems(List<String> items);
   ...
   * @return 非空Integer对象
   */
  public int update(Course newValue);
