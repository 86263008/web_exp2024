    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="objModelTitle">修改学生选课表记录</h5>
        ...
        <div class="modal-body">
          <form id="updateForm">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="update-courseNo" name="courseNo" required>
            </div>
            <div class="mb-3">
              <label for="update-stuNo" class="form-label">学号</label>
              <input type="text" class="form-control" id="update-stuNo" name="stuNo" required>
            </div>
            <div class="mb-3">
              <label for="update-grade" class="form-label">成绩</label>
              <input type="text" class="form-control" id="update-grade" name="grade" required>
            </div>
          </form>
        </div>
