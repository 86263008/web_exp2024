    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="objModelTitle">修改课程表记录</h5>
        ...
        <div class="modal-body">
          <form id="updateForm">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="update-preNo" name="preNo" required>
            </div>
            <div class="mb-3">
              <label for="update-credit" class="form-label">学分</label>
              <input type="text" class="form-control" id="update-credit" name="credit" required>
            </div>
          </form>
        </div>
